...
export function formatQuestion(question) {
    ...
    for (let i = 0; i < question.choices.length; i++) {
        ...
        const choiceLines = wordWrap(question.choices[i], inner - 4 - prefix.length - (isCorrect ? 4 : 0));
...
//# sourceMappingURL=question-formatter.js.map