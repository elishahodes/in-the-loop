export function getSystemPrompt(difficulty, mode = "stop") {
    const difficultyGuide = {
        beginner: "Ask about fundamental concepts. Assume the reader is learning programming.",
        intermediate: "Ask about design decisions, trade-offs, and best practices. Assume working developer knowledge.",
        advanced: "Ask about edge cases, performance implications, security considerations, and architectural patterns.",
    };
    if (mode === "tool_use") {
...
//# sourceMappingURL=question-system-prompt.js.map